...
<img src="/screenshots/readme-main-workspace.png" alt="AgentHangar main workspace" />
...
Open [http://localhost:6060](http://localhost:6060). See the [Installation](/get-started/installation) guide for more options.

## Subscription and authentication

AgentHangar is a local UI layer that runs on your machine. It does not have its own account system or billing.
...
All model inference happens through your own subscriptions. AgentHangar bridges your browser to these CLI tools over a local WebSocket connection.
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy" icon="cloud" href="/deploy/cloud-vm">
    Run AgentHangar on cloud VMs for always-on access with secure Tailscale networking.
  </Card>
</CardGroup>
