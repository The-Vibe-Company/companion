    ...
    <div className={`${embedded ? "h-full" : "h-[100dvh]"} bg-cc-bg text-cc-fg font-sans-ui antialiased overflow-y-auto`}>
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-6 sm:py-10 pb-safe">
        ...
        <div className="flex items-start justify-between gap-3 mb-6">
          <div>
            <IntegrationBreadcrumb current="Linear OAuth Apps" />
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1 text-xs text-cc-muted">
                          {conn.status === "connected"
                            ...
                            : "This app may already be installed in Linear, but AgentHangar no longer has a valid OAuth token. Reconnect it to restore agent replies."}
                        </p>
