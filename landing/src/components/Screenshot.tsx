        ...
        <FadeIn>
          <div className="cc-card bg-cc-card rounded-[20px] overflow-hidden">
            <div className="flex items-center justify-between gap-4 px-4 sm:px-5 py-3 border-b border-cc-border bg-[#f3e6d1]">
              ...
              <span className="font-mono-code text-[11px] text-cc-muted tracking-wide">agenthangar.session.dashboard</span>
            </div>
            <img
              src="/screenshot.png"
              alt="AgentHangar WebUI with multi-session agent output, MCP controls, and integrated terminal"
