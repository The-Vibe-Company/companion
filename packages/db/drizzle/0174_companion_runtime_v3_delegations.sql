...
BEGIN
  ...
  RETURNING token.org_id,token.companion_id,turn_row.actor_id,turn_row.id,turn_row.id;
END $$;
--> statement-breakpoint
...
BEGIN
  ...
  UPDATE public.companion_delegations SET status=NEW.state::text::public.companion_turn_status,
