...
WITH runtime_role AS (
  ...
  VALUES
    ...
    ('public.companion_v3_runtime_claim_preparation_v5(text,integer,integer)'),
    ('public.companion_v3_runtime_begin_admission(uuid,uuid,public.companion_v3_lane,uuid,uuid,bigint,bigint,integer)'),
