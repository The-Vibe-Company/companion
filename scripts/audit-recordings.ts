 ...
 *
 * Analyzes JSONL files in ~/.agenthangar/recordings/ and reports:
...
const recordingsDir = process.env.AGENTHANGAR_RECORDINGS_DIR || join(homedir(), ".agenthangar", "recordings");
